...
blacksmith_techs: list[Event] = [
    ...
    Research(TechInfo.PADDED_ARCHER_ARMOR,  time='07:00'),
    ...
    Research(TechInfo.PLATE_MAIL_ARMOR,     time='11:00'),
...
sections: SectionType = {
    ...
    BuildingInfo.ARCHERY_RANGE:  [archery_range_techs, archer_line, skirmisher_line, cavalry_archer_line, elephant_archer_line, hand_cannoneer_line],
    ...
    BuildingInfo.MONASTERY:      [monastery_techs, monk_line],
